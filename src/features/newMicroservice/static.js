export const templates = {
  ...
  packageJsonDependencies: '@babel/runtime @pnp/graph @pnp/nodejs @pnp/nodejs-commonjs @pnp/sp @pnp/sp-commonjs aws-sdk gd-sprest node-sp-auth request-promise',
  packageJsonDevDependencies: '@babel/cli @babel/core @babel/eslint-parser @babel/plugin-proposal-class-properties @babel/plugin-transform-runtime @babel/preset-env amazon-cognito-identity-js axios babel-jest babel-plugin-transform-class-properties babel-polyfill dotenv eslint eslint-config-airbnb eslint-config-airbnb-base eslint-plugin-import  eslint-plugin-jsx-a11y eslint-plugin-markdown eslint-plugin-react jest serverless-offline',
